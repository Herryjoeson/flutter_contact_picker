...
NSString*const CHANNEL = @"plugins.flutter.io/flutter_contact_picker";
...
@interface FlutterContactPickerPlugin () <CNContactPickerDelegate>
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  ...
  FlutterContactPickerPlugin* instance = [[FlutterContactPickerPlugin alloc] initWithViewController:viewController];
