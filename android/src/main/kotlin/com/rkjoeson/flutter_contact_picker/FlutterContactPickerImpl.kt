...
open class FlutterContactPickerImpl : PluginRegistry.ActivityResultListener, MethodChannel.MethodCallHandler {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?): Boolean {
        when (requestCode) {
            contactPageCode -> {
                if (data !== null) {
                    val contact = hashMapOf("fullName" to "", "phoneNumber" to "")
                    ...
                    while (cursor!!.moveToNext()) {
                        contact["fullName"] = cursor.getString(cursor.getColumnIndex(ContactsContract.CommonDataKinds.Phone.DISPLAY_NAME))
